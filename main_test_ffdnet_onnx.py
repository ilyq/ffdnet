...
# 加载 ONNX 模型
# onnx_model = onnx.load("ffdnet_quantized.onnx")

# 创建 ONNX Runtime 会话
# ort_session = ort.InferenceSession("ffdnet_quantized.onnx", providers=['CUDAExecutionProvider', 'CPUExecutionProvider'])
ort_session = ort.InferenceSession("ffdnet_quantized.onnx")

# 加载输入图像并预处理
input_image_path = "input_image.png"  # 输入图像路径

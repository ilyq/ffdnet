...
# 实例化模型并加载预训练权重
model = FFDNet(in_nc=in_nc, out_nc=out_nc, nc=nc, nb=nb, act_mode=act_mode)
model_path = os.path.join("model_zoo", "ffdnet_gray_clip.pth")
...
dummy_image = torch.randn(1, in_nc, 256, 256, requires_grad=False)
